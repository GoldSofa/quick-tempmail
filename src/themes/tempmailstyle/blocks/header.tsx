                                                ...
                                                {item.children?.map((subItem: NavItem, iidx) => (
                                                    <li key={iidx}>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="text-base" suppressHydrationWarning>{subItem.title}</div>
                                                        </Link>
                                                    </li>
                                                ))}
                                            </ul>
        ...
        return (
            <li {...props}>
                <NavigationMenuLink asChild>
                    <Link suppressHydrationWarning href={href} className="grid grid-cols-[auto_1fr] gap-3.5">
                        ...
                        <div className="space-y-0.5">
                            <div className="text-foreground text-sm font-medium" suppressHydrationWarning>{title}</div>
                            <p className="text-muted-foreground line-clamp-1 text-xs" suppressHydrationWarning>
                                {description}
                            </p>
                        </div>
                    </Link>
                                    ...
                                    {header.buttons &&
                                        header.buttons.map((button, idx) => (
                                            ...
                                            >
                                                ...
                                                <span suppressHydrationWarning>{button.title}</span>
                                            </Link>
                                        ))}
